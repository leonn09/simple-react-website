...
const Footer = () => {
    return (
        <footer id="footer" className="flex flex-col justify-center">
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-10 w-full">
                <div className="col-span-2 lg:col-span-3 backdrop-blur-sm p-10 flex flex-col gap-4 bg-zinc-200/20">
                    ...
                    <div className="text-[0.8rem] flex flex-col gap-2 max-w-[24rem]">
                        <p><span className="text-[1.1rem] font-semibold">01. </span>45 Corrales Avenue Centrio Mall, Misamis Oriental, Cagayan de Oro 9000</p>
                        <p><span className="text-[1.1rem] font-semibold">02. </span>661 Tondo Divisoria Market, Metro Manila 1012</p>
                    </div>
                </div>
                <div className="lg:col-span-2 backdrop-blur-sm p-10 flex flex-col gap-2 text-[0.8rem]">
                    <h3 className="text-[0.9rem] font-semibold">Top Categories</h3>
                ...
                <div className="lg:col-span-2 bg-zinc-200/30 backdrop-blur-sm p-10 flex flex-col gap-2 text-[0.8rem]">
                    <h3 className="text-[0.9rem] font-semibold">Important Links</h3>
                    <span className="block h-0.5 w-16 my-4 bg-current"></span>
                    <a>Link 1</a>
                    <a>Link 2</a>
                    <a>Link 3</a>
                ...
                <div className="lg:col-span-3 p-10 flex flex-col gap-1 md:items-center text-[0.8rem] col-span-2 md:col-span-4 bg-zinc-50/30 backdrop-blur-sm ">
                    ...
                    <div className="my-4 w-70 h-12 flex items-center">
                        <input
                            type="email"
            ...
            <div className="p-2 z-9 w-full bg-zinc-700/10 flex flex-col md:flex-row items-center justify-center md:justify-between">
                <p className="text-sm">
                    © 2025 Leonard Campano  
                </p>
                <div className="flex items-center gap-2">
                    <div className="flex items-center">
                        <svg className="fill-current" width="35px" height="35px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <svg className="fill-current" width="50px" height="50px" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
                        <title>visa</title>
                    ...
                    <svg width="35px" height="35px" viewBox="0 -54.25 482.51 482.51" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="flex items-center md:justify-end gap-4">
                    Follow Us:
                    <svg className="fill-current" width="20px" height="20px" viewBox="0 0 1920 1920" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <svg width="25px" height="25px" viewBox="0 -2 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
